...
The full Eval Specification is the detailed, executable version of the Eval Stub. It is authored by the Eval Owner using `templates/multimodal-eval-spec-template.md` and stored in the `hsrivatsa/Multimodal-AI-Evaluations` repository.
